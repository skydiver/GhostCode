...
extension Notification.Name {
    static let fullscreenDidEnter = Notification.Name("com.flydev.ghostcode.fullscreenDidEnter")
    static let fullscreenDidExit = Notification.Name("com.flydev.ghostcode.fullscreenDidExit")
}
