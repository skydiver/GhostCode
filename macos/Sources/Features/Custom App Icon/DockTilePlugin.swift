...
class DockTilePlugin: NSObject, NSDockTilePlugIn {
    ...
    #if DEBUG
    private let ghosttyUserDefaults = UserDefaults(suiteName: "com.flydev.ghostcode.debug")
    #else
    private let ghosttyUserDefaults = UserDefaults(suiteName: "com.flydev.ghostcode")
    #endif
